...
class LeafModel(object):
    ...
    def fit(self, A, Y, weights, fit_init=None, refit=False, mode = "mnl",
        ...
        Here, 
        A is a matrix m-by-(nxp), 
        where n is the number of alternatives, p is the number of features and m is the number of observations
        the columns are ordered in lexicographic order (feature, product) 
        starting with binary availability as the first feature
        
        Y is an m-sized 1 dimensional vector indicating the index of the purchase decision 
